...
// Intentar cargar mapa previo y configuración del suelo
...
// ESTRUCTURA CON PANEL "ACA" (DERECHA)
content.innerHTML = `
<div style="display: flex; background: #1a1a1a; color: white; font-family: 'Segoe UI', sans-serif; height: 90vh; border-radius: 8px; overflow: hidden; border: 1px solid #444;">
    
    <div style="flex: 1; position: relative; display: flex; flex-direction: column; background: #222;">
        <div style="padding: 10px; background: #2d2d2d; border-bottom: 1px solid #3d3d3d; display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: bold; color: #ccc;">🏗️ Funbox Viewport</span>
            <div>
                <button id="play" style="background: #4caf50; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-weight: bold;">🎮 JUGAR</button>
                <button id="clear" style="background: #f44336; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; margin-left: 5px;">🗑️ LIMPIAR</button>
            </div>
        </div>
        <canvas id="canvas" width="800" height="600" style="cursor: crosshair; background: #333; flex: 1;"></canvas>
    </div>

    <div style="width: 280px; background: #252525; border-left: 1px solid #3d3d3d; display: flex; flex-direction: column;">
        <div style="padding: 10px; background: #333; font-weight: bold; border-bottom: 1px solid #444; color: #888; font-size: 11px; text-transform: uppercase;">Explorador</div>
        
        <div style="flex: 1; overflow-y: auto; padding: 10px;">
            <div style="margin-bottom: 5px; cursor: default;">
                <span style="color: #ffd700;">📂</span> <strong>Workspace</strong>
                <div style="margin-left: 20px; padding: 4px 8px; background: #3d3d3d; border-radius: 4px; display: flex; align-items: center; border: 1px solid #4db8ff; margin-top: 5px;">
                    <span style="margin-right: 5px;">🟦</span> Baseplate
                </div>
            </div>
            <div style="margin-top: 10px; color: #aaa; font-size: 13px;">📂 StarterPlayer</div>
        </div>

        <div style="height: 220px; background: #1e1e1e; border-top: 2px solid #333;">
            <div style="padding: 8px; background: #2d2d2d; font-size: 10px; color: #888; text-transform: uppercase;">Propiedades - Baseplate</div>
            <div style="padding: 12px;">
                <label style="display: block; font-size: 12px; color: #bbb; margin-bottom: 5px;">Color del Suelo</label>
                <input type="color" id="floorColor" value="${floorConfig.color}" style="width: 100%; height: 25px; border: none; background: #333; cursor: pointer; margin-bottom: 15px;">
                ...
                <input type="number" id="floorSize" value="${floorConfig.size}" min="10" max="3500" 
                    style="width: 100%; background: #333; border: 1px solid #444; color: white; padding: 4px; border-radius: 2px;">
            </div>
        </div>
    </div>
</div>
...
function loop() {
  ...
  // Ajuste automático de tamaño de canvas
